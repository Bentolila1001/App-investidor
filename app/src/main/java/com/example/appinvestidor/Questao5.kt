...
import com.example.appinvestidor.databinding.FragmentQuestao5Binding
...
class Questao5 : Fragment() {
    ...
    fun onClickBtn(view: View){
        ...
        if(selectedId > 0){
            ...
            view.findNavController().navigate(R.id.action_questao5_to_questao6)
        }
    }
    ...
    private fun setupClickListeners(view: View) {
        ...
        binding.backButton.setOnClickListener{
            view.findNavController().navigate(R.id.action_questao5_to_questao4)
            data[0].Score -= selectScore
        }
    }

    private fun configQuestion() {
        binding.question1.text =  questions[4].Question
        binding.resp1.setText(questions[4].question1)
        binding.resp2.setText(questions[4].question2)
        binding.resp3.setText(questions[4].question3)
    }
}