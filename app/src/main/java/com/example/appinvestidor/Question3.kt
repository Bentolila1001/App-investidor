...
class Question3 : Fragment() {
    ...
    fun onClickBtn(view: View){
        ...
        if(selectedId > 0){
            ...
            view.findNavController().navigate(R.id.action_question3_to_questao42)
        }
    }
    ...
    private fun setupClickListeners(view: View) {
        ...
        binding.backButton.setOnClickListener{
            view.findNavController().navigate(R.id.action_question3_to_question2)
            data[0].Score -= selectScore
        }
    }

    private fun configQuestion() {
        binding.question1.text =  questions[2].Question
        binding.resp1.setText(questions[2].question1)
        binding.resp2.setText(questions[2].question2)
        binding.resp3.setText(questions[2].question3)
        binding.resp4.setText(questions[2].question4)
    }
}