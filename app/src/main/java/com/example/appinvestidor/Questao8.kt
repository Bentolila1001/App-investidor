...
class Questao8 : Fragment() {
    ...
    fun onClickBtn(view: View){
        ...
        if(selectedId > 0){
            ...
            view.findNavController().navigate(R.id.action_questao8_to_questao9)
        }
    }
    ...
    private fun setupClickListeners(view: View) {
        ...
        binding.backButton.setOnClickListener{
            view.findNavController().navigate(R.id.action_questao8_to_questao7)
            data[0].Score -= selectScore
        }
    }

    private fun configQuestion() {
        binding.question1.text =  questions[7].Question
        binding.resp1.setText(questions[7].question1)
        binding.resp2.setText(questions[7].question2)
        binding.resp3.setText(questions[7].question3)
        binding.resp4.setText(questions[7].question4)
    }
}